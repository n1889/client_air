package deng.utils
{
   ...
   public class ChecksumUtil extends Object
   {
      ...
      public static function CRC32(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         ...
         {
            var param2:uint = param1.length;
         }
         if(param3 == 0)
         {
            var param3:uint = param1.length - param2;
         }
         if(param3 + param2 > param1.length)
         {
            param3 = param1.length - param2;
         }
         var _loc5_:uint = 4.294967295E9;
         _loc4_ = param2;
         while(_loc4_ < param3)
         {
      ...
      public static function Adler32(param1:ByteArray, param2:uint = 0, param3:uint = 0) : uint
      {
         ...
         while(param3)
         {
            ...
            _loc5_ = (_loc5_ & 65535) + (_loc5_ >> 16) * 15;
            _loc6_ = (_loc6_ & 65535) + (_loc6_ >> 16) * 15;
         }
         if(_loc5_ >= 65521)
         {
            _loc5_ = _loc5_ - 65521;
