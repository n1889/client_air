package com.riotgames.platform.common.utils
{
   ...
   public class GUID extends Object
   {
      ...
      public static var summonerID:String = "";
      ...
      public static function create() : String
      {
         ...
         var _loc5_:String = summonerID;
         var _loc6_:String = calculate(_loc5_ + _loc2_ + _loc4_ + _loc3_ + counter++).toUpperCase();
         var _loc7_:String = _loc6_.substring(0,8) + "-" + _loc6_.substring(8,12) + "-" + _loc6_.substring(12,16) + "-" + _loc6_.substring(16,20) + "-" + _loc6_.substring(20,32);
         return _loc7_;
      }
