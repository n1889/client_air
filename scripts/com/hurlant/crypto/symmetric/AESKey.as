package com.hurlant.crypto.symmetric
{
   ...
   public class AESKey extends Object implements ISymmetricKey
   {
      ...
      private static function staticInit() : void
      {
         ...
         Rcon = new ByteArray();
         var _loc2_:uint = 0;
         while(_loc2_ < _Rcon.length)
         {
            Rcon[_loc2_] = _Rcon[_loc2_];
            _loc2_++;
         }
      }
      ...
      protected function invMixSubColumns() : void
      {
         ...
         _loc3_ = this.state[2];
         _loc4_ = this.state[3];
         _loc5_ = XtimeE[_loc1_] ^ XtimeB[_loc2_] ^ XtimeD[_loc3_] ^ Xtime9[_loc4_];
         _loc10_ = Xtime9[_loc1_] ^ XtimeE[_loc2_] ^ XtimeB[_loc3_] ^ XtimeD[_loc4_];
         _loc15_ = XtimeD[_loc1_] ^ Xtime9[_loc2_] ^ XtimeE[_loc3_] ^ XtimeB[_loc4_];
         _loc20_ = XtimeB[_loc1_] ^ XtimeD[_loc2_] ^ Xtime9[_loc3_] ^ XtimeE[_loc4_];
         _loc1_ = this.state[4];
         _loc2_ = this.state[5];
         _loc3_ = this.state[6];
         _loc4_ = this.state[7];
         _loc9_ = XtimeE[_loc1_] ^ XtimeB[_loc2_] ^ XtimeD[_loc3_] ^ Xtime9[_loc4_];
         _loc14_ = Xtime9[_loc1_] ^ XtimeE[_loc2_] ^ XtimeB[_loc3_] ^ XtimeD[_loc4_];
         _loc19_ = XtimeD[_loc1_] ^ Xtime9[_loc2_] ^ XtimeE[_loc3_] ^ XtimeB[_loc4_];
         _loc8_ = XtimeB[_loc1_] ^ XtimeD[_loc2_] ^ Xtime9[_loc3_] ^ XtimeE[_loc4_];
         _loc1_ = this.state[8];
         _loc2_ = this.state[9];
         _loc3_ = this.state[10];
         _loc4_ = this.state[11];
         _loc13_ = XtimeE[_loc1_] ^ XtimeB[_loc2_] ^ XtimeD[_loc3_] ^ Xtime9[_loc4_];
         _loc18_ = Xtime9[_loc1_] ^ XtimeE[_loc2_] ^ XtimeB[_loc3_] ^ XtimeD[_loc4_];
         _loc7_ = XtimeD[_loc1_] ^ Xtime9[_loc2_] ^ XtimeE[_loc3_] ^ XtimeB[_loc4_];
         _loc12_ = XtimeB[_loc1_] ^ XtimeD[_loc2_] ^ Xtime9[_loc3_] ^ XtimeE[_loc4_];
         _loc1_ = this.state[12];
         _loc2_ = this.state[13];
         _loc3_ = this.state[14];
         _loc4_ = this.state[15];
         _loc17_ = XtimeE[_loc1_] ^ XtimeB[_loc2_] ^ XtimeD[_loc3_] ^ Xtime9[_loc4_];
         _loc6_ = Xtime9[_loc1_] ^ XtimeE[_loc2_] ^ XtimeB[_loc3_] ^ XtimeD[_loc4_];
         _loc11_ = XtimeD[_loc1_] ^ Xtime9[_loc2_] ^ XtimeE[_loc3_] ^ XtimeB[_loc4_];
         _loc16_ = XtimeB[_loc1_] ^ XtimeD[_loc2_] ^ Xtime9[_loc3_] ^ XtimeE[_loc4_];
         this.state.position = 0;
         this.state[0] = InvSbox[_loc5_];
         this.state[1] = InvSbox[_loc6_];
         this.state[2] = InvSbox[_loc7_];
         this.state[3] = InvSbox[_loc8_];
         this.state[4] = InvSbox[_loc9_];
         this.state[5] = InvSbox[_loc10_];
         this.state[6] = InvSbox[_loc11_];
         this.state[7] = InvSbox[_loc12_];
         this.state[8] = InvSbox[_loc13_];
         this.state[9] = InvSbox[_loc14_];
         this.state[10] = InvSbox[_loc15_];
         this.state[11] = InvSbox[_loc16_];
         this.state[12] = InvSbox[_loc17_];
         this.state[13] = InvSbox[_loc18_];
         this.state[14] = InvSbox[_loc19_];
         this.state[15] = InvSbox[_loc20_];
      }
